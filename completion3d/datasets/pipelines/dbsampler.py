...
from mmdet3d.datasets.pipelines import (
    DataBaseSampler as _DataBaseSampler,
    ObjectSample as _ObjectSample
)


@OBJECTSAMPLERS.register_module(force=True)
class DataBaseSampler(_DataBaseSampler):
    def sample_all(self, gt_bboxes, gt_labels, img=None):
        ...
        if len(sampled) > 0:
            ...
            for info in sampled:
                ...
                group_ids.append(info['group_id'])
...
class ObjectSample(_ObjectSample):
    def __call__(self, input_dict):
        ...
        input_dict['dbsample_group_ids'] = sampled_dict['group_ids'] \
            if sampled_dict is not None else None
