...
db_sampler = dict(
    ...
    prepare=dict(
        ...
        filter_by_min_points=dict(Car=5, Truck=5, Van=5, Pedestrian=10, Person_sitting=10, Cyclist=10)),
    classes=class_names,
    sample_groups=dict(Car=12, Truck=3, Van=3, Pedestrian=6, Person_sitting=3, Cyclist=6))
...
evaluation = dict(interval=80, pipeline=eval_pipeline)
